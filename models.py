...
class PollingunitAgent(models.Model):
    ...
    polling_unit_uniqueid = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'pollingunit_agent'


class PollingunitAnnouncedlgaresult(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    user_ip_address = models.CharField(max_length=39)

    class Meta:
        managed = False
        db_table = 'pollingunit_announcedlgaresult'


class PollingunitAnnouncedpuresult(models.Model):
    id = models.BigAutoField(primary_key=True)
    polling_unit_uniqueid = models.CharField(max_length=100)
    party_abbreviation = models.CharField(max_length=20)
    party_score = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'pollingunit_announcedpuresult'


class PollingunitLga(models.Model):
    lga_id = models.IntegerField()
    lga_name = models.CharField(max_length=100)
    ...
    class Meta:
        managed = False
        db_table = 'pollingunit_lga'


class PollingunitParty(models.Model):
    party_name = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'pollingunit_party'


class PollingunitPollingunit(models.Model):
    polling_unit_id = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'pollingunit_pollingunit'


class PollingunitState(models.Model):
    state_name = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'pollingunit_state'


class PollingunitWard(models.Model):
    ward_id = models.IntegerField()
